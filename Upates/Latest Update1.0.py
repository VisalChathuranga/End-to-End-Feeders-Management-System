    ...
    def show_history():
        ...
        try:
            ...
            if found_records:
                ...
                history_label = tk.Label(history_window, text=f"Repair History for Serial Number: {serial_number}", font=("Arial", 14, "bold"))
                history_label.pack(pady=10)
                
                for record in found_records:
                    ctk.CTkLabel(history_window, text=f"Date: {record[0]}", font=("Arial", 12)).pack(pady=5)
                    ctk.CTkLabel(history_window, text=f"Feeder Type: {record[1]}", font=("Arial", 12)).pack(pady=5)
                    ctk.CTkLabel(history_window, text=f"Serial Number: {record[2]}", font=("Arial", 12)).pack(pady=5)
                    ctk.CTkLabel(history_window, text=f"Fault: {record[3]}", font=("Arial", 12)).pack(pady=5)
                    ctk.CTkLabel(history_window, text=f"Part Number: {record[4]}", font=("Arial", 12)).pack(pady=5)
                    ctk.CTkLabel(history_window, text=f"Repair History: {record[5]}", font=("Arial", 12)).pack(pady=5)
                    ctk.CTkLabel(history_window, text="------------------------", font=("Arial", 12, "italic")).pack(pady=10)
            else:
